...
Address.prototype.fromScript = function fromScript(script) {
  ...
  if (sh) {
    this.hash = sh;
    this.type = Address.types.SCRIPTHASH2;//###
    this.version = -1;
    return this;
  }
...
Address.prototype.isScripthash = function isScripthash() {
  return this.type === Address.types.SCRIPTHASH || this.type === Address.types.SCRIPTHASH2;
};
 ...
 * @param {Script} script
 */
Address.prototype.fromInputScriptAndWitness = function fromInputScriptAndWitness(script) {
...
Address.fromInputScriptAndWitness = function fromInputScriptAndWitness(script) {
  return new Address().fromInputScriptAndWitness(script);
};
//###
/*
 * Expose
